            ...
            <h3> Most Recent Projects </h3>                
                ...
                <div class="newsContent">
                            <div class="individualNews">
                                ...
                                <img src="../images/notice1.jpeg" width="100%px" height="100%">
                                </div>
                                <div class="individualTitle">
                                <a href="notice.php"> <h3> Software student has developed an incredible app called UBook </h3> </a>
                                </div>
                                <div class="individualAbstract"> 
                                    <p> With college books getting more and more expensive, our brilliant student from KULAC has developed an application with the Name of Ubook. What is Ubook? This app tackles the on and off the problem of overprices book... </p>
                                </div>
                            </div>
                            <div class="individualNews">
                                <div class="individualImage">
                                <img src="../images/notice.jpeg" width="100%px" height="100%">
                                </div>
                                <div class="individualTitle">
                                <a href="notice1.php"><h3>Easy Tour Project Between Business and Software Engineering Students </h3> </a>
                                </div>
                                <div class="individualAbstract"> 
                                    <p> Have you ever traveled somewhere and got lost just by walking around a corner? Or Have you ever wanted to travel somewhere but is too expensive? Well, KULAC has developed an application with the name of “Easy Tour”... </p>
                                </div>
                            </div>
                            <div class="individualNews">
                                <div class="individualImage">
                                <img src="../images/notice2.jpeg" width="100%px" height="100%">
                                </div>
                                <div class="individualTitle">
                                <a href="notice2.php"> <h3> G Tems Project Gaming Webpage project </h3> </a>
                                </div>
                                <div class="individualAbstract"> 
                                    <p> Good news for the Gaming Community! New devices and accessories from all brands and types, tired of your old gaming gear?! Well, we present to you Gtems! ,Students from KULAC have created a website and a mobile application where you can be in touch... </p>
                                </div>
                            </div>
